...
public class PointRecordResultView extends View {

    public String mPathToSave;
    public String mProgress;
    public String mMessage;

    public boolean isTestPassed = true;

    private TextPaint mPaintText;
    private TextPaint mResultPaintText;

    public PointRecordResultView(Context context, String pathToSave, String progress, String msg) {
        super(context);
